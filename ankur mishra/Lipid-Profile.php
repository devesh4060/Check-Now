...
.main-Hormones-box {
        ...
        .Hormones-box-column img {
            width: 100%;
            height: auto;
            border-radius: 10px;
        }
        .Hormones-box-text-column {
            display: flex;
            flex-direction: column;
            justify-content: center;
        }
        .Hormones-box-text-column p {
            font-size: 18px;
            line-height: 1.5;
            text-align: justify;
        }
        .Hormones-box-text-column h1{
          color: red;
          margin-left: 25%;
          font-size: 40px;
        }
...
<div class="main-Hormones-box">
    <div class="Hormones-box">
        <div class="Hormones-box-column">
            <img src="lipid-profile-img.jpg" alt="Image">
        </div>
        <div class="Hormones-box-column Hormones-box-text-column">
          <h1 class="Hormones-box-h1">About Hormones..</h1>
            <p>" 
                A liver profile, also known as a liver function test, is a blood test that checks how well your liver is working. It measures levels of enzymes, proteins, and substances like bilirubin that the liver produces or processes. These tests can detect liver damage, inflammation, or disease by showing if levels are too high or too low. The liver profile helps doctors diagnose conditions like hepatitis, fatty liver, and liver cirrhosis. By monitoring your liver's health, it ensures your body can properly filter toxins, produce bile, and manage other vital functions. "
           </p>
        </div>
    </div>
</div>
