...
<head>
    ...
    <title>Cardiac-markers-html-css</title>
...
.main-Cardiac-markers-box {
        ...
        .Cardiac-markers-box-column {
            flex: 1;
            min-width: 300px;
            padding: 20px;
        }
        .Cardiac-markers-box-column img {
            width: 100%;
            height: auto;
            border-radius: 10px;
        }
        .Cardiac-markers-box-text-column {
            display: flex;
            flex-direction: column;
            justify-content: center;
        }
        .Cardiac-markers-box-text-column p {
            font-size: 18px;
            line-height: 1.5;
            text-align: justify;
        }
        .Cardiac-markers-box-text-column h1{
          color: red;
          margin-left: 25%;
          font-size: 40px;
        }
...
<div class="main-Cardiac-markers-box">
    <div class="Cardiac-markers-box">
        <div class="Cardiac-markers-box-column">
            <img src="Read-Cardiac-Markers.jpg" alt="Image">
        </div>
        <div class="Cardiac-markers-box-column Cardiac-markers-box-text-column">
          <h1 class="Cardiac-markers-box-h1">About Cardiac markers..</h1>
            <p>
          "Cardiac markers are substances in the blood that help doctors diagnose heart conditions. They include proteins like troponin and enzymes like creatine kinase. When the heart is damaged, these markers leak into the bloodstream. By measuring their levels, doctors can determine if there’s been a heart attack or other heart issues. Cardiac markers are crucial for quick and accurate diagnosis, helping guide treatment decisions and monitoring heart health."
        </p>
        </div>
    </div>
</div>
